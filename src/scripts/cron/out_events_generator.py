...
def cron_generate_out_events(
    ...
    #  обрабатывать от 5*60=300 и да 20*60=1200 событий вначале года при 100к пользователей;
    #  И в будущем даже при 1кк юзеров, будет от 3.000 до 12.000 событий в минуту.
    ...
    #  .
    #  Плюсы: 1 запрос на ивенты, 1 запрос на юзеров, легко реализуется вначале
    #         и имеет запас к масштабированию (разделить по типам ивентов)
